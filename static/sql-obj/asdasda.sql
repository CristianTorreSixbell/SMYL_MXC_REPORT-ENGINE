EXEC sp_helptext ALTER PROCEDURE GetConversationDetailsByDate_2 
exec sp_helptext GetConversationDetailsByDate_2
...
EXEC GetConversationDetailsByDate_2   '2025-01-10  00:00:00',  '2025-01-10  01:00:00';
SELECT * FROM ##Result; DROP TABLE ##Result;