...
//         this.tokenExpiration = process.argv[8] || null;
...
//         }catch(e){
//             this.logEvent('ERROR', `Error encrypting token ${e}`, 0);
//             console.log(e)
...
//             const token = jwt.sign(payload,  'b1aYx6aU4aWEN9YnvPMsYMuLV6mKdPEw9', options);
